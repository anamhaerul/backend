...
@Service
public class MahasiswaFileService {
     ...
     */
    // simpan foto baru
    public String storeFotoMahasiswa(String namaBase, MultipartFile file) throws IOException {
        ...
        Path uploadPath = Paths.get(uploadDirMahasiswa);
    ...
    public void deleteFotoMahasiswa(String filename) throws IOException {
